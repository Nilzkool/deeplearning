...
X_train, X_test, Y_train, Y_test = train_test_split(X_orig, Y_orig, test_size=0.1,stratify=Y_orig)
X_train=X_train.T
...
#import pickle
#final_weights_digits=pickle.load(open("final_weights_digits.p","rb"))
#L_layer_NN.check_gradients(final_weights_digits,X_train_std,Y_train,act_hl="relu",act_fl="sigmoid",epsilon=10e-7,regularization=None)
