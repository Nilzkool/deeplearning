...
# First download the library L_layer_NN.py 
...
os.chdir(cur_dir)
import sys
lib_dest='C:/Users/Google Drive/Scripts' # This is the folder where you save L_layer_NN.py 
...
# The output is the optimized weights

n_x=X_train.shape[0]
layer_dims=[n_x,3,2,1] 
regu_para=None
#regu_para={'L2':1}
...
# Set regularization to None before running 
